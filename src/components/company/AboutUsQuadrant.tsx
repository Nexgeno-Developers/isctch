  ...
  return (
    <section className="w-full bg-gray-50">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 pb-0 md:pb-10">
        <div className="flex items-center justify-center p-5 md:p-12 md:pb-0 lg:p-16 xl:p-16 order-2 lg:order-1">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 pt-10 md:pt-20">
        ...
        <div className="flex items-center justify-center p-5 md:p-12 md:pb-0 lg:p-16 xl:p-16">
          <div className="max-w-2xl">
